...
My personal agentic engineering setup — terminal, editor, Claude Code, voice input, and lavish — documented as a living HTML guide.

**Live guide:** https://manjesh-raj.github.io/ai-setup-guide/

## What's in here

- `index.html` — the full setup guide, single self-contained HTML file

## Backed-up tools

Personal forks kept as backups in case upstream repos are removed or change:
...
Workflow approach from Kun Chen's video: https://www.youtube.com/watch?v=iQyg-KypKAA
